...
export function makeProduct(overrides: Partial<Product> = {}): Product {
  return {
    ...
    allowedOrientations: overrides.allowedOrientations,
    stackable: overrides.stackable,
    fragile: overrides.fragile,
    crushable: overrides.crushable,
    maxStackLoadLb: overrides.maxStackLoadLb,
    nestingPercent: overrides.nestingPercent,
    caseWidth: overrides.caseWidth,
    caseDepth: overrides.caseDepth,
    caseHeight: overrides.caseHeight,
    caseWeight: overrides.caseWeight,
    shelfReadyTray: overrides.shelfReadyTray,
...
export function makeProject(overrides: Partial<DisplayProject> = {}): DisplayProject {
  return {
    ...
    palletSpec: overrides.palletSpec,
